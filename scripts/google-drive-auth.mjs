...
// drive.file: this app can create/upload/move files of its own.
// drive.readonly: lets it browse/search folders and files it didn't create (e.g. find an
// existing file by name in a shared Drive folder) — read-only, no write/delete access outside drive.file.
