...
| Issue tracker | 2026-09-03 | `tracking/issue-tracker.csv`, `.xlsx`, `.md` | Flat checklist built from the audit: one row per issue with category or page, issue, what is happening, fix, priority, roadmap reference and a status column. Tick rows off as fixes go live. |
