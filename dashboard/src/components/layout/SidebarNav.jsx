        ...
        <nav className="flex flex-col items-center gap-4">
          {NAV_ITEMS.map((item) => (
            <button
              ...
              title={item.label}
              className="press focus-ring flex h-10 w-10 items-center justify-center rounded-lg text-lg text-charcoal/60 transition-colors hover:bg-mist hover:text-signal dark:text-slate-400 dark:hover:bg-slate-800/60"
            >
